$(document).ready(function () {
    ...
    // Interceptez le clic sur le lien "Créez un compte" et ouvrez la boîte de dialogue modale.
    $('a#createAccountLink').on('click', function (e) {
        e.preventDefault();
        $('#adminAccessCodeModal').modal('show');
    });

    // Vérifiez le code d'accès administrateur et redirigez vers la vue "CreateUser" si le code est correct.
